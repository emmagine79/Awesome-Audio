...
/**
 * Get total algorithmic delay in samples for delay compensation.
 *
 * Returns:
 *     - Total delay = (fft_size - hop_size) + (lookahead * hop_size)
 */
uintptr_t df_get_delay_samples(DFState *st);
